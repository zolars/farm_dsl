...
public class FarmParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, FarmGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getReportFunctionAccess().getAlternatives(), "rule__ReportFunction__Alternatives");
			...
			builder.put(grammarAccess.getTaskAccess().getStatementsAlternatives_8_0(), "rule__Task__StatementsAlternatives_8_0");
			...
			builder.put(grammarAccess.getReportFunctionAccess().getGroup_1(), "rule__ReportFunction__Group_1__0");
			...
			builder.put(grammarAccess.getGetCropValueFunctionAccess().getGroup(), "rule__GetCropValueFunction__Group__0");
			builder.put(grammarAccess.getGetFieldValueFunctionAccess().getGroup(), "rule__GetFieldValueFunction__Group__0");
			...
			builder.put(grammarAccess.getReportFunctionAccess().getReportCropAssignment_0(), "rule__ReportFunction__ReportCropAssignment_0");
			builder.put(grammarAccess.getReportFunctionAccess().getReportFieldAssignment_1_0(), "rule__ReportFunction__ReportFieldAssignment_1_0");
			...
			builder.put(grammarAccess.getGetCropValueFunctionAccess().getGetValueCropAssignment_0(), "rule__GetCropValueFunction__GetValueCropAssignment_0");
			builder.put(grammarAccess.getGetCropValueFunctionAccess().getGetCropAttributeAssignment_2(), "rule__GetCropValueFunction__GetCropAttributeAssignment_2");
			builder.put(grammarAccess.getGetFieldValueFunctionAccess().getGetValueFieldAssignment_0(), "rule__GetFieldValueFunction__GetValueFieldAssignment_0");
			builder.put(grammarAccess.getGetFieldValueFunctionAccess().getGetFieldAttributeAssignment_2(), "rule__GetFieldValueFunction__GetFieldAttributeAssignment_2");
