 ...
 * </p>
 * <ul>
 *   <li>{@link uk.ac.kcl.farm.farm.impl.LoopStatementImpl#getCount <em>Count</em>}</li>
...
public class LoopStatementImpl extends StatementImpl implements LoopStatement
{
  ...
  public NotificationChain basicSetCount(IntExpression newCount, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, FarmPackage.LOOP_STATEMENT__COUNT, oldCount, newCount);
  ...
  public void setCount(IntExpression newCount)
  {
    if (newCount != count)
    {
      ...
      if (count != null)
        msgs = ((InternalEObject)count).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - FarmPackage.LOOP_STATEMENT__COUNT, null, msgs);
      if (newCount != null)
        msgs = ((InternalEObject)newCount).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - FarmPackage.LOOP_STATEMENT__COUNT, null, msgs);
      msgs = basicSetCount(newCount, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, FarmPackage.LOOP_STATEMENT__COUNT, newCount, newCount));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case FarmPackage.LOOP_STATEMENT__COUNT:
