...
public class FarmPackageImpl extends EPackageImpl implements FarmPackage
{
  ...
  public void initializePackageContents()
  {
    ...
    initEReference(getFarmProgram_Statements(), this.getStatement(), null, "statements", null, 0, -1, FarmProgram.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
